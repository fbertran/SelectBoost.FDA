...
#> 1    signal        1    signal          basis       fpca                  grid
#> 2  nuisance        2  nuisance          basis     spline                  grid
...
#> 1       2500 c0 = 0.6      0.6666667          1.00                 2
#> 2       2500 c0 = 0.6      0.4000000          0.75                 4
#> 3        age c0 = 0.6      0.5000000          0.50                 1
#> 4  treatment c0 = 0.6      1.0000000          1.00                 1
```
...
#> 2       2500              0.0500000                 0.125                 0
#> 3        age              0.0000000                 0.000                 0
#> 4  treatment              0.2500000                 0.250                 0
...
#> 3                  grid          1              5            5           B5
#> 4                scalar          1              1            1          age
#> 5                scalar          1              1            1    treatment
#>   end_argval     domain_start       domain_end mean_feature_frequency
#> 1        PC3             1100             2500              0.4166667
#> 2         B4             1100 2464.10256410256              0.0625000
#> 3         B5 1817.94871794872             2500              0.0000000
#> 4        age              age              age              0.0000000
#> 5  treatment        treatment        treatment              0.2500000
#>   max_feature_frequency selected_features group_frequency group_selected
#> 1                 0.750                 2           0.750           TRUE
#> 2                 0.125                 0           0.125          FALSE
#> 3                 0.000                 0           0.000          FALSE
#> 4                 0.000                 0           0.000          FALSE
#> 5                 0.250                 0           0.250          FALSE
...
#> 1 feature         42       9         31  9 22  0 11 0.2903226      1
#> 2 feature         42       9         37  9 28  0  5 0.2432432      1
#> 3   group          4       3          4  3  1  0  0 0.7500000      1
#> 4   group          4       3          4  3  1  0  0 0.7500000      1
#>   specificity        f1   jaccard selection_rate       c0            method
#> 1   0.3333333 0.4500000 0.2903226      0.7380952 c0 = 0.5       selectboost
#> 2   0.1515152 0.3913043 0.2432432      0.8809524 c0 = 0.5 plain_selectboost
...
to a subdirectory of `tempdir()`, so it does not write into the package
directory by default. The committed files under
